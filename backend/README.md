...
## Project Structure
    ...
    ├── testappplanupgra_de_55271  # Django project configurations
...
1. Clone this repo and `cd testappplanupgra_de_55271`
...
2. Clone this repo and `cd testappplanupgra_de_55271`
